...
// import { MaybePlayNext } from '../Jotai/API';
...
import {
  ...
  shuffleState,
  repeatState
} from '../Jotai/PlaybackState';
// import { currentSongKeyStat } from '../Jotai/SongPlayback';
...
const { log, wrn } = MakeLog('EMP:render:SongPlayback');
wrn.enabled = true;
...
function CoverArt(): JSX.Element {
  ...
  return (
    <span id="song-cover-art">
      <img id="img-current-cover-art" src="http://www.foo.bar/cover.jpg" alt="album cover" />
    </span>
  );
}
