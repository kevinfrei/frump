...
export const hasAnySongsState = atom(false);
export const shuffleState = atom(false);
export const repeatState = atom(false);
export const hasNextSongState = atom(false);
export const hasPrevSongState = atom(false);
export const mutedState = atom(false); // WithMainStorage('mute', false, isBoolean);
export const volumeState = atom(0.5); // WithMainStorage('volume', 0.5, isNumber);
